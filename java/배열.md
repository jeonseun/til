...
double[][] location2d;   // 2차원 배열, yx축 좌표계
double[][][] location3d; // 3차원 배열, zyx축 좌표계
```
...
- [Java Language Specification se21 #ch10 - Oracle](https://docs.oracle.com/javase/specs/jls/se21/html/jls-10.html)
